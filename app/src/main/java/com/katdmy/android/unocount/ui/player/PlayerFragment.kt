...
class PlayerFragment : Fragment(R.layout.player_fragment) {
    ...
    private val playerViewModel: PlayerViewModel by activityViewModels { PlayerViewModelFactory(requireActivity()) }
    ...
    private fun setRecyclerView() {
        ...
        adapter = PlayerAdapter(deletePlayer, changePlayerActivity)
